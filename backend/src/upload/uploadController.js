...
cloudinary.config({
    cloud_name: process.env.CLOUD_NAME || "dqkhno2rz",
    api_key: process.env.CLOUD_API_KEY || "934659338216897",
    api_secret: process.env.CLOUD_API_SECRET || "nI9ktjHpZ-YigP1AheiFkr-2vf4",
});
